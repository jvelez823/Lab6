...
// modify player's movement speed
var playerXSpeed = 8;
...
// modify gravity
var gravity = 10;
// modify player's jump speed
var jumpSpeed = 9;
// modify player's movement speed
var playerYSpeed = 8;


// modify moveY (added death variable)
Player.prototype.moveY = function(step, level, keys) {
  this.speed.y += step * gravity;
  var motion = new Vector(0, this.speed.y * step);
  var newPos = this.pos.plus(motion);
  var obstacle = level.obstacleAt(newPos, this.size);
// putting the vector at 10,10  
  var death = new Vector (10, 10)
  
// check for lava and death 
  if (obstacle == 'death' && 'lava') {
